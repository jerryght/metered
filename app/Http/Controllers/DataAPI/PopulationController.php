...
class PopulationController extends Controller{
    ...
    function growth(){
        ...
        $year = DB::select("select distinct(year(`year`)) as `year` from `country_populations`");
        $years = $this->ToArray($year,'year');
    ...
    function incease(){
        ...
        $year = country_wealth::distinct()->get(['year']);
        echo json_encode(array('years'=>$this->ToArray($year,'year'),'country'=>$who,'count'=>$data));
    }
    function count(){
        ...
        $year = country_wealth::distinct()->get(['year']);
        echo json_encode(array('years'=>$this->ToArray($year,'year'),'country'=>$EnglishName,'count'=>$data));
    }
}